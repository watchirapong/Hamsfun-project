...
const levelOneBossAttack: BossAttackPattern = ({ bossRef, config, spawnBullet }) => {
...
const levelOneConfig: LevelConfig = {
  id: 'level-1',
  name: 'Bullet Hell - Level 1',
  canvas: {
    width: CANVAS_WIDTH,
  ...
  boss: {
    ...
    bulletSpeed: 2,
    shootInterval: 800,
    attackPattern: levelOneBossAttack,
    laser: {
      interval: 5000,
      duration: 2000,
      widthRatio: 0.8,
...
export default function LevelOne({ playerStats, onLevelComplete, onPlayerDefeated }: LevelProps) {
